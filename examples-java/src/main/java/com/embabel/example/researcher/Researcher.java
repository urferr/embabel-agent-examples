...
public class Researcher {
	...
	@Action(pre = { REPORT_UNSATISFACTORY }, post = {
			REPORT_SATISFACTORY }, canRerun = true, outputBinding = "gpt4Report")
	 ...
	 */
	@Action(post = { REPORT_SATISFACTORY }, outputBinding = "claudeReport", canRerun = true)
	 ...
	 */
	@Action(pre = { REPORT_UNSATISFACTORY }, post = {
			REPORT_SATISFACTORY }, outputBinding = "claudeReport", canRerun = true)
